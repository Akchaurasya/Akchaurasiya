...
## Education
- PhD Scholar, Mahindra University.
...
## Research Projects
- Incremental Weighted Exponential Discriminant Analysis (IWEDA)
- Incremental LDA for Face Recognition
- Hybrid QR-SVD based Discriminant Analysis
